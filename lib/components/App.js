...
// import Perf from 'react-addons-perf' //needs to be run with query param react_perf   ?
...
export default class App extends PureComponent {
  ...
  getAppState = () => { //Cant place this function after the state property. //TODO See how it is hoisted
  ...
  onStoreChange = (newState) => {
    const { articles, searchTerm } = newState
    this.setState({ articles, searchTerm })
  }
