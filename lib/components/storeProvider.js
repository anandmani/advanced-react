...
export default (extraPropsFn) => (Component) => {
  class WithStore extends PureComponent {
    onStoreChange = () => this.forceUpdate()  //This is very inefficient as the Component will re-render for any change in the store. Not just the ones that are subscribed to
    componentDidMount = () => {
